// Auto-ported 1:1 from apps/mobile/lib/i18n/app_strings.dart — do not hand-edit; regenerate.
...
export const DICT: Record<string, { en: string; hu: string }> = {
  ...
  "workout.save_failed": { en: "Couldn’t save the workout. Check your connection and try again.", hu: "Nem sikerült menteni az edzést. Ellenőrizd a kapcsolatot, és próbáld újra." },
  "workout.rest_over": { en: "Rest over", hu: "Pihenő letelt" },
  "workout.rest_get_ready": { en: "Get ready for the next set", hu: "Készülj a következő szettre" },
  ...
  "workout.kcal_estimated": { en: "≈ {n} kcal burned", hu: "≈ {n} kcal elégetve" },
  "workout.kcal_failed": { en: "Calorie estimate failed", hu: "Kalóriabecslés sikertelen" },
  "workout.kcal_fill_hint": { en: "Fill in reps for every set to estimate calories", hu: "Töltsd ki minden sorozat ismétlését a becsléshez" },
  "workout.menu_finish": { en: "Finish workout", hu: "Edzés befejezése" },
  "workout.menu_pause": { en: "Exit – continue later", hu: "Kilépés – később folytatom" },
  ...
  "workout.strat_linear_desc": { en: "+weight every time", hu: "Minden alkalommal +súly" },
  "workout.strat_double": { en: "Double progression", hu: "Dupla progresszió" },
  "workout.strat_double_desc": { en: "Reps first, then weight", hu: "Előbb ismétlés, majd súly" },
  "workout.strat_rpe": { en: "RPE-based", hu: "RPE alapú" },
  "workout.strat_rpe_desc": { en: "Targeted load at RPE 7–8", hu: "RPE 7–8 célzott terhelés" },
  "workout.strat_none": { en: "None", hu: "Nincs" },
  "workout.strat_none_desc": { en: "Don’t suggest anything", hu: "Ne javasoljon semmit" },
  "workout.how_to": { en: "How to", hu: "Hogyan" },
  "workout.watch_youtube": { en: "Watch on YouTube", hu: "Megnézés YouTube-on" },
  "workout.no_more_exercises": { en: "No more exercises", hu: "Nincs több gyakorlat" },
  "workout.exit": { en: "Exit", hu: "Kilépés" },
  "workout.exercise_fallback": { en: "Exercise", hu: "Gyakorlat" },
  "workout.finish_confirm_title": { en: "Finish workout?", hu: "Edzés befejezése?" },
  "workout.finish_confirm_body": { en: "{count} exercise(s) still have unchecked sets. Finish anyway?", hu: "{count} gyakorlatnál maradt bepipálatlan szett. Mindenképp befejezed?" },
  ...
  "welcome.tagline": { en: "Strength engineered intelligently.", hu: "Erő, intelligensen tervezve." },
  "welcome.subtitle": { en: "Adaptive training that learns from every set you log.", hu: "Adaptív edzés, ami minden naplózott szettedből tanul." },
  ...
  "welcome.headline": { en: "Pure training.\nNo bloat.", hu: "Tiszta edzés.\nSemmi felesleg." },
  "welcome.body": { en: "Create an account — then in 90 seconds we tailor a training plan to your goals.", hu: "Hozz létre egy fiókot — utána 90 másodperc alatt összeállítjuk a céljaidra szabott edzéstervet." },
  ...
  "auth.no_account": { en: "No account? Create one", hu: "Nincs fiókod? Hozz létre egyet" },
  "auth.have_account": { en: "Have an account? Sign in", hu: "Van fiókod? Jelentkezz be" },
  "auth.login_subtitle": { en: "Sign in and chase a new PR.", hu: "Lépj be és csinálj egy új PR-t." },
  ...
  "auth.server_unreachable": { en: "Couldn't reach the server.", hu: "Nem sikerült elérni a szervert." },
  "auth.invalid_email": { en: "Enter a valid email address.", hu: "Adj meg egy érvényes email címet." },
  "auth.password_min_8": { en: "Password must be at least 8 characters.", hu: "A jelszó legalább 8 karakter legyen." },
  "auth.register_subtitle_default": { en: "Create an account so we can save your workouts.", hu: "Hozz létre egy fiókot, hogy elmentsük az edzéseidet." },
  "auth.register_subtitle_with_plan": { en: "Save your plan to your account.", hu: "Mentsd el a tervedet a fiókodhoz." },
  "auth.register_title_with_plan": { en: "Last step", hu: "Utolsó lépés" },
  "auth.register_title_default": { en: "Create account", hu: "Fiók létrehozása" },
  "auth.name_optional": { en: "Name (optional)", hu: "Név (opcionális)" },
  "auth.password_min_8_label": { en: "Password (min. 8 characters)", hu: "Jelszó (min. 8 karakter)" },
  "auth.create_account_button": { en: "Create account", hu: "Fiók létrehozása" },
  "auth.have_account_leading": { en: "Already have an account?", hu: "Van már fiókod?" },
  "auth.have_account_action": { en: "Sign in", hu: "Lépj be" },
  "auth.terms_lead": { en: "By creating an account you accept the ", hu: "A fiók létrehozásával elfogadod az " },
  "auth.terms_and": { en: " and the ", hu: " és az " },
  "auth.terms_link": { en: "Terms of service", hu: "Felhasználási feltételeket" },
  "auth.privacy_link": { en: "Privacy policy", hu: "Adatvédelmi tájékoztató" },
  "auth.reset_title": { en: "Reset password", hu: "Jelszó visszaállítás" },
  "auth.reset_subtitle": { en: "Enter your email and we will send a reset link.", hu: "Add meg az email címedet, küldünk egy visszaállító linket." },
  "auth.reset_sent_title": { en: "Email on the way", hu: "Email úton van" },
  "auth.reset_sent_body": { en: "If {email} is registered we've sent a reset link. Check your inbox (and the spam folder) — it's valid for 30 minutes.", hu: "Ha a(z) {email} regisztrált, küldtünk egy visszaállító linket. Nézd meg a postafiókod (és a spam mappát) — 30 percig érvényes." },
  "auth.reset_have_code": { en: "I have a reset link or code", hu: "Van visszaállító linkem vagy kódom" },
  "auth.reset_step2_title": { en: "Set a new password", hu: "Adj meg egy új jelszót" },
  "auth.reset_step2_subtitle": { en: "Paste the link from the email (or just the code) and choose a new password.", hu: "Illeszd be az emailből kapott linket (vagy csak a kódot) és válassz egy új jelszót." },
  "auth.reset_token_label": { en: "Reset link or code", hu: "Visszaállító link vagy kód" },
  "auth.reset_token_hint": { en: "https://heftor.app/reset-password?token=…", hu: "https://heftor.app/reset-password?token=…" },
  "auth.reset_token_required": { en: "Paste the link or code from the email.", hu: "Illeszd be a linket vagy kódot az emailből." },
  "auth.reset_new_password_label": { en: "New password", hu: "Új jelszó" },
  "auth.reset_confirm_password_label": { en: "Confirm new password", hu: "Új jelszó újra" },
  "auth.reset_passwords_dont_match": { en: "The two passwords do not match.", hu: "A két jelszó nem egyezik." },
  "auth.reset_button": { en: "Reset password", hu: "Jelszó visszaállítása" },
  "auth.reset_invalid_or_expired": { en: "This link or code is invalid or has expired. Request a new one.", hu: "Ez a link vagy kód érvénytelen vagy lejárt. Kérj újat." },
  "auth.or": { en: "or", hu: "vagy" },
  "auth.continue_with_apple": { en: "Continue with Apple", hu: "Folytatás Apple-lel" },
  "auth.continue_with_google": { en: "Continue with Google", hu: "Folytatás Google-lel" },
  ...
  "auth.reset_link_sent": { en: "If the email exists you will receive a reset link.", hu: "Ha az email létezik, kapsz egy visszaállító linket." },
  "auth.password_too_short": { en: "Password must be at least 6 characters.", hu: "A jelszó legalább 6 karakter legyen." },
  "dashboard.hi": { en: "Hi,", hu: "Szia," },
  "dashboard.month_total": { en: "{kg} kg this month", hu: "{kg} kg ebben a hónapban" },
  "dashboard.streak": { en: "STREAK", hu: "STREAK" },
  "dashboard.rank": { en: "RANK", hu: "RANG" },
  "dashboard.today_done": { en: "TODAY · DONE", hu: "MA · KÉSZ" },
  "dashboard.today_no_workout": { en: "TODAY · NO WORKOUT", hu: "MA · NINCS EDZÉS" },
  "dashboard.today_card_planned": { en: "Today · planned", hu: "Ma · tervezett" },
  ...
  "dashboard.no_workout_today": { en: "No workout planned for today.", hu: "Mára nincs tervezett edzés." },
  "dashboard.stagnation_title": { en: "Progress plateau detected", hu: "Megrekedt fejlődés" },
  ...
  "dashboard.no_workout_today_short": { en: "No workout", hu: "Nincs edzésed" },
  "dashboard.start_short": { en: "START", hu: "KEZDÉS" },
  "dashboard.month_total_kg": { en: "{kg} kg this month", hu: "{kg} kg ebben a hónapban" },
  "dashboard.month_total_t": { en: "{kg} t this month", hu: "{kg} t ebben a hónapban" },
  "dashboard.split_per_week": { en: "{split} · {days}× / week", hu: "{split} · {days}× / hét" },
  "dashboard.weekly_done": { en: "{done}/{goal} this week", hu: "{done}/{goal} ezen a héten" },
  "dashboard.done_short": { en: "DONE", hu: "KÉSZ" },
  "dashboard.exercises_short_caps": { en: "EXERCISES", hu: "GYAKORLAT" },
  "dashboard.exercises_count": { en: "{n} exercises", hu: "{n} gyakorlat" },
  "dashboard.workout_default": { en: "Workout", hu: "Edzés" },
  "dashboard.no_workout_that_day": { en: "No workout that day", hu: "Nem volt edzés ezen a napon" },
  "dashboard.create_with_plus": { en: "Create one with the + button", hu: "Hozz létre egyet a + gombbal" },
  ...
  "run.subtitle": { en: "Enter the distance and time.", hu: "Add meg a távot és az időt." },
  ...
  "run.need": { en: "Enter a distance or time.", hu: "Adj meg távot vagy időt." },
  "run.failed": { en: "Couldn't save.", hu: "Nem sikerült menteni." },
  "dashboard.stagnation_label": { en: "{n} EXERCISES STAGNATING · VIEW", hu: "{n} GYAKORLAT STAGNÁL · NÉZD MEG" },
  "dashboard.weeks_stagnant": { en: "{n} weeks stalled", hu: "{n} hét stagnál" },
  ...
  "trainings.generate_new_plan": { en: "Generate new weekly plan", hu: "Új heti terv generálása" },
  "trainings.your_first_plan": { en: "YOUR FIRST PLAN", hu: "ELSŐ TERVED" },
  "trainings.counts_recommended_only": { en: "{n} recommended", hu: "{n} ajánlott" },
  "trainings.counts_full": { en: "{manual} own · {gen} generated · {rec} recommended", hu: "{manual} saját · {gen} generált · {rec} ajánlott" },
  "trainings.make_a_plan_title": { en: "Make a plan\nfor yourself.", hu: "Csinálj egy tervet\nmagadnak." },
  "trainings.make_a_plan_body": { en: "Pick weeks + sessions per week + muscle groups and get a plan in moments.", hu: "Választasz hét + edzés/hét + izomcsoport, és pillanatok alatt megkapod a tervet." },
  "trainings.tab_recommended": { en: "RECOMMENDED", hu: "AJÁNLOTT" },
  "trainings.tab_generated": { en: "GENERATED", hu: "GENERÁLT" },
  "trainings.empty_my_title": { en: "You don't have your own workouts yet", hu: "Még nincs saját edzésed" },
  "trainings.empty_my_subtitle": { en: "Create one with the top-right button.", hu: "Hozz létre egyet a jobb felső gombbal." },
  ...
  "workouts.empty_my": { en: "You have no saved workouts yet.", hu: "Még nincs mentett edzésed." },
  ...
  "create.search_exercises": { en: "Search exercises…", hu: "Gyakorlat keresése…" },
  "create.all_filter": { en: "All", hu: "Mind" },
  "create.give_name": { en: "Give your workout a name.", hu: "Adj nevet az edzésnek." },
  "create.add_exercise": { en: "Add at least one exercise.", hu: "Adj hozzá legalább egy gyakorlatot." },
  "create.db_unavailable": { en: "The exercise database is currently unavailable.", hu: "A gyakorlat-adatbázis jelenleg nem elérhető." },
  "create.too_many_requests": { en: "Too many requests. Try again later.", hu: "Túl sok kérés. Próbáld újra később." },
  "create.server_unreachable": { en: "Couldn't reach the server.", hu: "Nem sikerült elérni a szervert." },
  "create.save_failed": { en: "Couldn't save. Is the server up?", hu: "Nem sikerült menteni. Fut a szerver?" },
  "custom.title": { en: "Own exercise", hu: "Saját gyakorlat" },
  "custom.subtitle_card": { en: "If it's not in the catalogue, add it as your own", hu: "Ha nincs a katalógusban, vedd fel sajátként" },
  "custom.intro": { en: "Add your own movement when it's not in the catalogue. Setting the muscle group keeps the weekly volume counter accurate.", hu: "Vedd fel a saját mozdulatodat, ha nincs a katalógusban. Az izomcsoport megadása segít, hogy a heti volumen számláló pontos maradjon." },
  "custom.name_label": { en: "Name *", hu: "Neve *" },
  "custom.name_hint": { en: "e.g. Trap-3 raise", hu: "pl. Trap-3 raise" },
  "custom.name_required": { en: "Give the exercise a name", hu: "Adj nevet a gyakorlatnak" },
  ...
  "custom.muscle_pick": { en: "Pick a muscle group", hu: "Válassz izomcsoportot" },
  "custom.muscle_freeform_hint": { en: "e.g. chest, back, quads", hu: "pl. chest, back, quads" },
  "custom.equipment_label": { en: "Equipment (optional)", hu: "Eszköz (opcionális)" },
  "custom.equipment_hint": { en: "e.g. dumbbell, cable, body weight", hu: "pl. dumbbell, cable, body weight" },
  "custom.note_label": { en: "Note (optional)", hu: "Megjegyzés (opcionális)" },
  "custom.note_hint": { en: "Cue, weight position, RPE target etc.", hu: "Tipp, súly-pozíció, RPE-target stb." },
  "custom.gif_label": { en: "GIF / image URL (optional)", hu: "GIF / kép URL (opcionális)" },
  "custom.gif_hint": { en: "https://… (GIF, PNG or JPG)", hu: "https://… (GIF, PNG vagy JPG)" },
  "custom.gif_invalid": { en: "Enter a full URL (https://…)", hu: "Adj meg teljes URL-t (https://…)" },
  "custom.gif_invalid_scheme": { en: "Only http(s) URLs are supported", hu: "Csak http(s) URL támogatott" },
  "custom.preview": { en: "Preview", hu: "Előnézet" },
  "custom.preview_invalid": { en: "Invalid URL", hu: "Érvénytelen URL" },
  "custom.add_to_workout": { en: "Add to workout", hu: "Hozzáadás az edzéshez" },
  ...
  "account.delete_confirm_title": { en: "Delete account", hu: "Fiók törlése" },
  "account.delete_confirm_body": { en: "Are you sure you want to delete your account? This action cannot be undone.", hu: "Biztosan törlöd a fiókod? Ez a művelet nem visszavonható." },
  "account.delete_failed": { en: "Couldn't delete the account.", hu: "Nem sikerült törölni a fiókot." },
  "account.rank": { en: "RANK", hu: "RANG" },
  "account.world_leaderboard": { en: "WORLD LEADERBOARD", hu: "VILÁGRANGLISTA" },
  "account.this_week_xp": { en: "This week · +{xp} XP", hu: "Ez a hét · +{xp} XP" },
  ...
  "calendar.new_alltime_record": { en: "New all-time record", hu: "Új all-time rekord" },
  "calendar.week_streak": { en: "WEEK STREAK", hu: "HÉT SOROZAT" },
  "calendar.streak_hint_caps": { en: "WEEK STREAK · ALL-TIME RECORD ON THE RIGHT", hu: "HÉT SOROZAT · ALL-TIME REKORD JOBB OLDALON" },
  "calendar.alltime_record_caps": { en: "NEW ALL-TIME RECORD", hu: "ÚJ ALL-TIME REKORD" },
  "calendar.streak_at_risk": { en: "STREAK ON THE LINE — TRAIN TODAY", hu: "A STREAK A KOCKÁN — EDZS MA" },
  "calendar.week_still_open": { en: "YOUR WEEK IS STILL OPEN", hu: "A HETED MÉG NYITOTT" },
  "calendar.start_streak_again": { en: "START THE STREAK AGAIN", hu: "INDÍTSD ÚJRA A SOROZATOT" },
  "calendar.summary_caps": { en: "{sessions} SESSION · {streak} WEEK STREAK RECORD · {pr} PR THIS MONTH", hu: "{sessions} EDZÉS · {streak} HÉT REKORD STREAK · {pr} PR EBBEN A HÓNAPBAN" },
  "calendar.observations_caps": { en: "OBSERVATIONS", hu: "MEGFIGYELÉSEK" },
  "calendar.muscles_this_month_caps": { en: "MUSCLES · THIS MONTH", hu: "IZMOK · EZ A HÓNAP" },
  "calendar.rest_day_text": { en: "Rest day", hu: "Pihenőnap" },
  "calendar.no_workout_on_day": { en: "No workout recorded on this day.", hu: "Nincs rögzített edzés ezen a napon." },
  "calendar.no_workout_this_month": { en: "No workouts this month yet", hu: "Még nincs edzés ebben a hónapban" },
  "calendar.delta_up": { en: "↑ +{n} VS LAST MONTH", hu: "↑ +{n} A MÚLT HÓNAPHOZ KÉPEST" },
  "calendar.delta_down": { en: "↓ {n} VS LAST MONTH", hu: "↓ {n} A MÚLT HÓNAPHOZ KÉPEST" },
  "calendar.delta_same": { en: "= VS LAST MONTH", hu: "= A MÚLT HÓNAPHOZ KÉPEST" },
  "calendar.sessions_count_caps": { en: "{n} SESSION", hu: "{n} EDZÉS" },
  ...
  "progress.subtitle": { en: "{n} WORKOUTS · {vol} LIFTED", hu: "{n} EDZÉS · {vol} MEGEMELT" },
  ...
  "progress.empty_history_title": { en: "No finished workouts yet", hu: "Még nincs befejezett edzésed" },
  "progress.empty_history_subtitle": { en: "Start a workout from the dashboard — every session shows up here, grouped by date.", hu: "Indíts egy edzést a dashboardról — innen majd minden session megjelenik dátum szerint csoportosítva." },
  "progress.empty_exercises_title": { en: "No data yet", hu: "Még nincs adat" },
  "progress.empty_exercises_subtitle": { en: "Log workouts to see your progress.", hu: "Naplózz edzéseket, hogy lásd a fejlődésed." },
  "progress.n_exercises": { en: "{n} exercises", hu: "{n} gyakorlat" },
  "progress.n_sessions": { en: "{n} sessions", hu: "{n} alkalom" },
  "progress.chart_need_two": { en: "At least 2 sessions are needed for the chart", hu: "Legalább 2 alkalom kell a grafikonhoz" },
  ...
  "progress.detail_sets_value": { en: "{done}/{total} sets", hu: "{done}/{total} szett" },
  "progress.detail_started": { en: "Started: {time}", hu: "Kezdés: {time}" },
  "progress.detail_finished": { en: "Finished: {time}", hu: "Befejezés: {time}" },
  ...
  "onboarding.welcome_title": { en: "Tell us about your goal", hu: "Mondj el a célodról" },
  "onboarding.continue": { en: "Continue", hu: "Folytatás" },
  "onboarding.skip": { en: "Skip", hu: "Kihagyás" },
  "onboarding.save_failed": { en: "Couldn't save your onboarding.", hu: "Nem sikerült menteni az onboardingot." },
  ...
  "paywall.subtitle": { en: "Unlock the full coach. Cancel anytime.", hu: "Nyisd meg a teljes coach-ot. Bármikor lemondható." },
  ...
  "paywall.price_yearly_total": { en: "17 990 Ft / year", hu: "17 990 Ft / év" },
  "paywall.price_yearly_effective": { en: "1 499 Ft / month — billed yearly", hu: "1 499 Ft / hó — évente számlázva" },
  "paywall.save_badge": { en: "SAVE 40%", hu: "−40%" },
  "paywall.trial_cta": { en: "Start 3-day free trial", hu: "3 napos próba indítása" },
  "paywall.subscribe_cta": { en: "Subscribe", hu: "Előfizetés" },
  "paywall.trial_used": { en: "You've already used your free trial.", hu: "Már használtad a próbaidőszakod." },
  "paywall.restore": { en: "Restore purchases", hu: "Vásárlások visszaállítása" },
  "paywall.fineprint": { en: "3-day free trial then 2 490 Ft / month. Cancel anytime in your App Store / Play settings.", hu: "3 napos ingyenes próba után 2 490 Ft / hó. Bármikor lemondható az App Store / Play beállításokban." },
  "paywall.feature_unlimited_workouts": { en: "Unlimited saved workouts", hu: "Korlátlan mentett edzés" },
  "paywall.feature_engine": { en: "Adaptive progression engine", hu: "Adaptív progresszió-motor" },
  "paywall.feature_history": { en: "Full progress history", hu: "Teljes fejlődéstörténet" },
  "paywall.feature_plan": { en: "20-week plan generator", hu: "20 hetes terv-generátor" },
  "paywall.feature_pr_detect": { en: "Real PR detection (e1RM)", hu: "Valós PR detektálás (e1RM)" },
  "paywall.feature_stories": { en: "Generated workout stories", hu: "Generált edzés-stori-k" },
  "paywall.feature_priority": { en: "Priority support", hu: "Elsőbbségi support" },
  "paywall.purchase_failed": { en: "Could not complete the purchase. Please try again.", hu: "A vásárlás nem sikerült. Próbáld újra." },
  "subscription.section": { en: "Subscription", hu: "Előfizetés" },
  "subscription.status_free": { en: "Free", hu: "Ingyenes" },
  "subscription.status_trialing": { en: "Trial · {days}d left", hu: "Próba · {days} nap van hátra" },
  "subscription.status_active_monthly": { en: "Pro · Monthly", hu: "Pro · Havi" },
  "subscription.status_active_yearly": { en: "Pro · Yearly", hu: "Pro · Éves" },
  "subscription.status_cancelled": { en: "Cancelled · until {date}", hu: "Lemondva · {date}-ig" },
  "subscription.status_expired": { en: "Expired", hu: "Lejárt" },
  "subscription.cta_upgrade": { en: "Upgrade to Pro", hu: "Frissítés Pro-ra" },
  "subscription.cta_manage": { en: "Manage subscription", hu: "Előfizetés kezelése" },
  "subscription.cancel": { en: "Cancel subscription", hu: "Előfizetés lemondása" },
  "subscription.cancel_confirm_title": { en: "Cancel subscription?", hu: "Lemondod az előfizetést?" },
  "subscription.cancel_confirm_body": { en: "You'll keep Pro access until the current period ends, then drop back to Free.", hu: "A jelenlegi időszak végéig megtartod a Pro-t, utána visszaválthat Ingyenesre." },
  ...
  "plan.linked_workout_label": { en: "LINKED WORKOUT", hu: "CSATOLT EDZÉS" },
  "plan.linked_workout_hint": { en: "Pick one to copy its muscles into this day.", hu: "Válassz egyet, hogy az izomcsoportjai töltsék be ezt a napot." },
  "plan.no_workouts": { en: "No saved workouts yet.", hu: "Még nincs mentett edzésed." },
  "plan.save": { en: "SAVE", hu: "MENTÉS" },
  "plan.saved": { en: "Weekly plan updated.", hu: "Heti terv frissítve." },
  "plan.save_failed": { en: "Couldn't save.", hu: "Mentés sikertelen." },
  "plan.notification_permission_required": { en: "Allow notifications in Settings so reminders work.", hu: "Engedélyezd az értesítéseket a beállításokban a működéshez." },
  ...
  "plan.reminder_section": { en: "DAILY REMINDER", hu: "NAPI EMLÉKEZTETŐ" },
  "plan.reminder_subtitle": { en: "Push notification on planned training days.", hu: "Push értesítés a tervezett edzések napjain." },
  "plan.reminder_enabled": { en: "Reminder enabled", hu: "Emlékeztető bekapcsolva" },
  ...
  "free_limit.title": { en: "Free workout limit reached", hu: "Elérted az ingyenes limitet" },
  "free_limit.body": { en: "Free accounts can save up to {n} workouts. Upgrade to Pro for unlimited workouts and the full coach.", hu: "Ingyenes fiókokon maximum {n} edzést menthetsz. Frissíts Pro-ra a korlátlan edzésekért és a teljes coach-ért." },
  ...
  "insights.most_common_day": { en: "YOU TRAIN MOST ON {day} ({count}×)", hu: "{day} EDZESZ LEGTÖBBET ({count} ALKALOM)" },
  "insights.least_common_day": { en: "{day} IS YOUR RAREST", hu: "{day} A LEGRITKÁBB" },
  "insights.avg_start": { en: "YOU USUALLY START AT {time}", hu: "ÁTLAGOSAN {time}-KOR KEZDESZ" },
  "insights.avg_duration": { en: "AVG SESSION: {min} MIN", hu: "ÁTLAG SESSION: {min} PERC" },
  "insights.hl_biggest_session": { en: "BIGGEST SESSION", hu: "LEGNAGYOBB SESSION" },
  ...
  "generator.generated_snack": { en: "{count} workouts generated.", hu: "{count} edzés generálva." },
  "generator.network_error": { en: "Network error. Please try again.", hu: "Hálózati hiba. Próbáld újra." },
  "generator.cta": { en: "GENERATE {count} WORKOUTS", hu: "GENERÁLD A(Z) {count} EDZÉST" },
  "generator.eyebrow": { en: "GENERATED FOR YOU", hu: "NEKED GENERÁLT" },
  "generator.title": { en: "How fast do you want to reach your shape?", hu: "Mennyi idő alatt érnéd el a formádat?" },
  "generator.subtitle": { en: "Pick how many workouts a week, and we’ll build exactly that many plans.", hu: "Választasz heti hány edzést, és pontosan annyi tervet készítünk." },
  ...
  "generator.muscles_hint": { en: "Leave empty for all ten groups, or pick a specific focus.", hu: "Hagyd üresen mind a tíz csoporthoz, vagy válassz konkrét fókuszt." },
  "generator.clear_selection": { en: "CLEAR SELECTION", hu: "KIVÁLASZTÁS TÖRLÉSE" },
  "generator.preview": { en: "PREVIEW", hu: "ELŐNÉZET" },
  "generator.plan_unit": { en: "WORKOUTS", hu: "EDZÉSTERV" },
  "generator.preview_line": { en: "{weeks} weeks × {sessions} workouts.", hu: "{weeks} hét × {sessions} edzés." },
  "generator.preview_all_muscles": { en: "All muscle groups.", hu: "Az összes izomcsoport." },
  "generator.preview_focus": { en: "{count} focus muscles.", hu: "{count} fókuszizom." },
  "onboarding.goal_title": { en: "What’s your goal?", hu: "Mi a célod?" },
  "onboarding.goal_subtitle": { en: "We’ll tailor the program to it.", hu: "Erre szabjuk a programot." },
  "onboarding.goal_lose_fat": { en: "Lose fat", hu: "Fogyás" },
  "onboarding.goal_lose_fat_sub": { en: "Keep muscle in a deficit", hu: "Tartsd meg az izmot deficit alatt" },
  "onboarding.goal_build_muscle": { en: "Build muscle", hu: "Izomépítés" },
  "onboarding.goal_build_muscle_sub": { en: "Maximum hypertrophy", hu: "Maximális hipertrófia" },
  "onboarding.goal_strength": { en: "Strength & performance", hu: "Erő és teljesítmény" },
  "onboarding.goal_strength_sub": { en: "Raise your 1RM on the main lifts", hu: "Növeld az 1RM-et a fő gyakorlatokon" },
  "onboarding.goal_maintain": { en: "Maintain", hu: "Fenntartás" },
  "onboarding.goal_maintain_sub": { en: "Keep muscle, refine your look", hu: "Tartsd az izmot, javítsd az összképet" },
  "onboarding.exp_title": { en: "How experienced are you?", hu: "Mennyi a tapasztalatod?" },
  "onboarding.exp_subtitle": { en: "How long have you trained regularly?", hu: "Mióta edzel rendszeresen?" },
  "onboarding.exp_beginner": { en: "Beginner", hu: "Kezdő" },
  "onboarding.exp_beginner_sub": { en: "Less than 1 year", hu: "Kevesebb mint 1 év" },
  ...
  "onboarding.exp_elite_sub": { en: "5+ years, coaching knowledge", hu: "5+ év, edzői tudás" },
  "onboarding.body_title": { en: "A few things about you", hu: "Pár adat rólad" },
  "onboarding.body_subtitle": { en: "We tune your weekly volume to these.", hu: "Ezekre szabjuk a heti volument." },
  ...
  "onboarding.schedule_subtitle": { en: "How many days, and how long?", hu: "Hány nap edzés, mennyi időre?" },
  "onboarding.days_per_week": { en: "Training days / week", hu: "Edzésnap / hét" },
  "onboarding.days_optimal": { en: "OPTIMAL FOR YOUR LEVEL", hu: "OPTIMÁLIS A SZINTEDHEZ" },
  "onboarding.days_recovery_edge": { en: "On the edge of recovery", hu: "A regenerálás határán" },
  "onboarding.days_fine": { en: "Fine", hu: "Megfelelő" },
  "onboarding.session_length": { en: "Length of one workout", hu: "Egy edzés hossza" },
  "onboarding.split_title": { en: "Training split", hu: "Edzésfelosztás" },
  "onboarding.split_subtitle": { en: "How should we organise the weeks?", hu: "Hogyan szervezzük a heteket?" },
  "onboarding.split_full_body_sub": { en: "Every muscle every day, high frequency", hu: "Minden izom minden nap, magas frekvencia" },
  "onboarding.split_upper_lower_sub": { en: "Upper and lower body on separate days", hu: "Felső- és alsótest külön napokon" },
  "onboarding.split_ppl_sub": { en: "Push, pull, legs on separate days", hu: "Tolás, húzás, láb külön napokon" },
  "onboarding.split_bro_sub": { en: "One muscle group / day, 5–6 day week", hu: "Egy izomcsoport / nap, 5–6 napos hét" },
  "onboarding.recommended": { en: "RECOMMENDED", hu: "AJÁNLOTT" },
  "onboarding.volume_title": { en: "Your weekly optimum", hu: "A heti optimumod" },
  "onboarding.volume_subtitle": { en: "This many working sets per muscle gives ideal results.", hu: "Ennyi munka-szett izomcsoportonként ad ideális eredményt." },
  "onboarding.save_plan": { en: "Save my plan", hu: "Mentsd a tervemet" },
  "onboarding.volume_unit": { en: "sets / muscle / week", hu: "szett / izom / hét" },
  "onboarding.volume_source": { en: "Based on RP MEV / MAV", hu: "RP MEV / MAV alapján" },
  "onboarding.fine_tune": { en: "Tune", hu: "Hangold" },
  "onboarding.try_a_set": { en: "Try a set first →", hu: "Próbálj egy szettet előbb →" },
