// AUTO-GENERATED from apps/mobile/lib/i18n/app_strings.dart — do not edit by hand.
// 1:1 copy of the mobile app's i18n dictionary (654 keys, en + hu).

export type Lang = "en" | "hu";

export const dict: Record<string, { en: string; hu?: string }> = {
  "common.save": {
    "en": "Save",
    "hu": "Mentés"
  },
  ...
  "workout.estimate_kcal": {
    "en": "Estimate calories",
    "hu": "Kalória becslése"
  },
  "workout.kcal_value": {
    "en": "≈ {n} kcal",
  ...
  "workout.strat_double": {
    "en": "Double progression",
    "hu": "Dupla progresszió"
  },
  ...
  "welcome.try_demo": {
    "en": "Try a demo workout",
    "hu": "Próbálj egy demó edzést"
  },
  "welcome.headline": {
    "en": "Pure training.\nNo bloat.",
    "hu": "Tiszta edzés.\nSemmi felesleg."
  ...
  "welcome.body": {
    "en": "Create an account — then in 90 seconds we tailor a training plan to your goals.",
    "hu": "Hozz létre egy fiókot — utána 90 másodperc alatt összeállítjuk a céljaidra szabott edzéstervet."
  },
  "welcome.cta": {
    "en": "Let's go",
    "hu": "Kezdjük"
  },
  "welcome.have_account": {
    "en": "Already have an account? ",
    "hu": "Van már fiókod? "
  },
  "welcome.sign_in_link": {
    "en": "Sign in",
    "hu": "Lépj be"
  },
  "auth.email": {
  ...
  "auth.no_account_leading": {
    "en": "No account yet?",
    "hu": "Nincs még fiókod?"
  },
  "auth.no_account_action": {
    "en": "Sign up",
    "hu": "Regisztrálj"
  },
  ...
  "auth.reset_sent_body": {
    "en": "If {email} is registered we've sent a reset link. Check your inbox (and the spam folder) — it's valid for 30 minutes.",
    "hu": "Ha a(z) {email} regisztrált, küldtünk egy visszaállító linket. Nézd meg a postafiókod (és a spam mappát) — 30 percig érvényes."
  },
  ...
  "auth.reset_step2_subtitle": {
    "en": "Paste the link from the email (or just the code) and choose a new password.",
    "hu": "Illeszd be az emailből kapott linket (vagy csak a kódot) és válassz egy új jelszót."
  },
  ...
  "dashboard.stagnation_badge": {
    "en": "PLATEAU",
    "hu": "STAGNÁLÁS"
  },
  "dashboard.workout_saved": {
    "en": "Workout saved",
    "hu": "Edzés elmentve"
  },
  "dashboard.today_short": {
    "en": "TODAY",
    "hu": "MA"
  },
  ...
  "dashboard.done_short": {
    "en": "DONE",
    "hu": "KÉSZ"
  },
  "dashboard.exercises_short_caps": {
    "en": "EXERCISES",
    "hu": "GYAKORLAT"
  },
  ...
  "dashboard.stat_total_sets": {
    "en": "Total sets",
    "hu": "Összes set"
  },
  "dashboard.stat_lifted": {
    "en": "Lifted",
    "hu": "Megemelt"
  },
  "dashboard.stat_active_time": {
    "en": "Active time",
    "hu": "Aktív idő"
  },
  "dashboard.stat_sessions": {
    "en": "Sessions",
    "hu": "Edzések"
  },
  "dashboard.new_pr": {
  ...
  "trainings.make_a_plan_body": {
    "en": "Pick weeks + sessions per week + muscle groups and get a plan in moments.",
    "hu": "Választasz hét + edzés/hét + izomcsoport, és pillanatok alatt megkapod a tervet."
  },
  "trainings.tab_recommended": {
    "en": "RECOMMENDED",
    "hu": "AJÁNLOTT"
  },
  "trainings.tab_generated": {
    "en": "GENERATED",
    "hu": "GENERÁLT"
  },
  ...
  "workouts.generated_for_you": {
    "en": "GENERATED FOR YOU",
    "hu": "NEKED GENERÁLT"
  },
  ...
  "create.give_name": {
    "en": "Give your workout a name.",
    "hu": "Adj nevet az edzésnek."
  },
  "create.add_exercise": {
  ...
  "custom.intro": {
    "en": "Add your own movement when it's not in the catalogue. Setting the muscle group keeps the weekly volume counter accurate.",
    "hu": "Vedd fel a saját mozdulatodat, ha nincs a katalógusban. Az izomcsoport megadása segít, hogy a heti volumen számláló pontos maradjon."
  },
  "custom.name_label": {
    "en": "Name *",
    "hu": "Neve *"
  ...
  "custom.name_too_long": {
    "en": "Max 80 characters",
    "hu": "Legfeljebb 80 karakter"
  },
  "custom.muscle_label": {
    "en": "Target muscle group",
    "hu": "Célzott izomcsoport"
  },
  "custom.muscle_pick": {
  ...
  "detail.target_muscles": {
    "en": "Target muscles",
    "hu": "Célzott izmok"
  },
  "detail.secondary_muscles": {
  ...
  "account.plate_calculator": {
    "en": "Plate calculator",
    "hu": "Tárcsa kalkulátor"
  },
  "account.bar_weight": {
    "en": "Bar weight (kg)",
    "hu": "Rúd súlya (kg)"
  },
  "account.available_plates": {
    "en": "Available plates (kg)",
    "hu": "Elérhető tárcsák (kg)"
  },
  "account.add_plate": {
    "en": "New plate",
    "hu": "Új tárcsa"
  ...
  "account.settings_saved": {
    "en": "Setting saved",
    "hu": "Beállítás mentve"
  },
  "account.couldnt_save": {
    "en": "Couldn't save.",
    "hu": "Nem sikerült menteni."
  },
  "account.couldnt_change": {
    "en": "Couldn't change.",
    "hu": "Nem sikerült módosítani."
  },
  "account.logout": {
    "en": "Sign out",
    "hu": "Kijelentkezés"
  ...
  "account.delete_confirm_body": {
    ...
    "hu": "Biztosan törlöd a fiókod? Ez a művelet nem visszavonható."
  },
  ...
  "calendar.summary_caps": {
    ...
    "hu": "{sessions} EDZÉS · {streak} HÉT REKORD STREAK · {pr} PR EBBEN A HÓNAPBAN"
  },
  ...
  "progress.tab_history": {
    "en": "History",
    "hu": "Előzmények"
  },
  "progress.tab_exercises": {
    "en": "Exercises",
    "hu": "Gyakorlatok"
  },
  "progress.subtitle": {
  ...
  "progress.stat_workouts": {
    "en": "WORKOUTS",
    "hu": "EDZÉS"
  },
  "progress.stat_lifted": {
    "en": "LIFTED",
    "hu": "MEGEMELT"
  },
  "progress.stat_active_time": {
    "en": "ACTIVE TIME",
    "hu": "AKTÍV IDŐ"
  },
  ...
  "progress.empty_history_subtitle": {
    "en": "Start a workout from the dashboard — every session shows up here, grouped by date.",
    "hu": "Indíts egy edzést a dashboardról — innen majd minden session megjelenik dátum szerint csoportosítva."
  },
  ...
  "progress.metric_max_weight": {
    "en": "Max Weight",
    "hu": "Max súly"
  },
  "progress.metric_volume": {
    "en": "Volume",
    "hu": "Volumen"
  },
  "progress.metric_total_reps": {
    "en": "Total Reps",
    "hu": "Össz. ism."
  },
  "progress.detail_done": {
    "en": "Done",
    "hu": "Kész"
  },
  "progress.detail_time": {
    "en": "Time",
    "hu": "Idő"
  },
  ...
  "paywall.fineprint": {
    "en": "3-day free trial then 2 490 Ft / month. Cancel anytime in your App Store / Play settings.",
    "hu": "3 napos ingyenes próba után 2 490 Ft / hó. Bármikor lemondható az App Store / Play beállításokban."
  },
  ...
  "subscription.cancel_confirm_body": {
    "en": "You'll keep Pro access until the current period ends, then drop back to Free.",
    "hu": "A jelenlegi időszak végéig megtartod a Pro-t, utána visszaválthat Ingyenesre."
  },
  "plan.title": {
    "en": "WEEKLY PLAN",
    "hu": "HETI TERV"
  ...
  "plan.saved": {
    "en": "Weekly plan updated.",
    "hu": "Heti terv frissítve."
  },
  "plan.save_failed": {
    "en": "Couldn't save.",
  ...
  "plan.notification_permission_required": {
    ...
    "hu": "Engedélyezd az értesítéseket a beállításokban a működéshez."
  },
  "plan.day_short_h": {
    "en": "M",
    "hu": "H"
  ...
  "free_limit.body": {
    "en": "Free accounts can save up to {n} workouts. Upgrade to Pro for unlimited workouts and the full coach.",
    "hu": "Ingyenes fiókokon maximum {n} edzést menthetsz. Frissíts Pro-ra a korlátlan edzésekért és a teljes coach-ért."
  },
  "free_limit.cta": {
    "en": "See Pro",
    "hu": "Pro megnyitása"
  ...
  "insights.workout_fallback": {
    "en": "WORKOUT",
    "hu": "EDZÉS"
  },
  "generator.muscle_chest": {
    "en": "CHEST",
    "hu": "MELL"
  },
  "generator.muscle_back": {
    "en": "BACK",
    "hu": "HÁT"
  },
  "generator.muscle_shoulders": {
    "en": "SHOULDERS",
    "hu": "VÁLL"
  },
  "generator.muscle_biceps": {
    "en": "BICEPS",
    "hu": "BICEPSZ"
  },
  "generator.muscle_triceps": {
    "en": "TRICEPS",
    "hu": "TRICEPSZ"
  },
  "generator.muscle_quads": {
    "en": "QUADS",
    "hu": "COMB"
  },
  "generator.muscle_hamstrings": {
    "en": "HAMSTRINGS",
    "hu": "COMBHAJLÍTÓ"
  },
  "generator.muscle_glutes": {
    "en": "GLUTES",
    "hu": "FAR"
  },
  "generator.muscle_calves": {
    "en": "CALVES",
    "hu": "VÁDLI"
  },
  "generator.muscle_abs": {
    "en": "ABS",
    "hu": "HAS"
  },
  ...
  "generator.weeks_label": {
    "en": "Weeks",
    "hu": "Hét"
  },
  "generator.weeks_unit": {
    "en": "WEEKS",
    "hu": "HÉT"
  },
  "generator.sessions_label": {
    "en": "Workouts / week",
    "hu": "Edzés / hét"
  },
  "generator.muscles_label": {
    "en": "Muscle groups",
    "hu": "Izomcsoportok"
  },
  ...
  "onboarding.cardio_none": {
    "en": "None",
    "hu": "Semmi"
  },
  "onboarding.cardio_light": {
    "en": "Light",
    "hu": "Kevés"
  },
  "onboarding.cardio_moderate": {
    "en": "Moderate",
    "hu": "Közepes"
  },
  "onboarding.cardio_high": {
    "en": "A lot",
    "hu": "Sok"
  },
  "onboarding.schedule_title": {
    "en": "Your weekly rhythm",
    "hu": "Heti ritmusod"
  },
  ...
  "onboarding.save_plan": {
    "en": "Save my plan",
    "hu": "Mentsd a tervemet"
  },
  ...
  "autherr.generate_failed": {
    "en": "Couldn't generate the plan.",
    "hu": "Generálás sikertelen."
  },
  "autherr.save_failed": {
    "en": "Couldn't save.",
    "hu": "Mentés sikertelen."
  ...
  "demo.bench_muscles": {
    "en": "Chest · Triceps · Front delt",
    "hu": "Mell · Triceps · Elülső deltoid"
  },
  "demo.done_body": {
    "en": "This is what a set looks like. From now on we'll keep track of the rest of your workouts, PRs and weekly volume — if you save to your account.",
    "hu": "Így néz ki egy szett. A többi edzésed, PR-jeid és heti volumented mostantól számon tartjuk — ha mented a fiókodba."
  },
  "demo.done_title": {
    "en": "You're done.",
    "hu": "Készen vagy."
  ...
  "demo.save_progress": {
    ...
    "hu": "Mentsd a haladásod"
  },
  "demo.try_hint": {
    "en": "Demo set — nothing is saved, just give it a try.",
    "hu": "Bemutató szett — semmi nem mentődik, csak próbáld."
  },
  "exercise.change_exercise": {
    "en": "Change exercise",
    "hu": "Gyakorlat cseréje"
  },
  "exercise.no_data": {
    "en": "No data",
    "hu": "Nincs adat"
  ...
  "hyrox.create_failed": {
    ...
    "hu": "Nem sikerült létrehozni a tervet."
  },
  "hyrox.create_footnote": {
    "en": "One tap creates all 36 training days. You can delete and recreate it anytime.",
    "hu": "Egy kattintás létrehozza mind a 36 edzésnapot. Bármikor törölheted és újra létrehozhatod."
  },
  "hyrox.create_plan": {
    "en": "Create plan",
    "hu": "Terv létrehozása"
  },
  "hyrox.default_weights_note": {
    "en": "The default weights are for the Men Open division.",
    "hu": "Az alapértelmezett súlyok a Férfi Open divízióé."
  },
  "hyrox.delete_failed": {
    "en": "Couldn't delete.",
    "hu": "Nem sikerült törölni."
  },
  "hyrox.delete_plan_body": {
    "en": "Are you sure you want to delete the entire HYROX plan?",
    "hu": "Biztosan törlöd a teljes HYROX tervet?"
  },
  "hyrox.delete_plan_title": {
    "en": "Delete plan",
    "hu": "Terv törlése"
  },
  "hyrox.division_label": {
    "en": "DIVISION",
    "hu": "DIVÍZIÓ"
  },
  "hyrox.division_men_open": {
    "en": "Men Open",
    "hu": "Férfi Open"
  },
  "hyrox.division_men_pro": {
    "en": "Men Pro",
    "hu": "Férfi Pro"
  },
  "hyrox.division_women_open": {
    "en": "Women Open",
    "hu": "Női Open"
  },
  "hyrox.division_women_pro": {
    "en": "Women Pro",
    "hu": "Női Pro"
  },
  "hyrox.exercises_sets": {
    "en": "{exercises} exercises · {sets} sets",
    "hu": "{exercises} gyakorlat · {sets} szett"
  },
  "hyrox.intro_description": {
    "en": "12-week preparation plan · 3 training days per week · 4 phases (Base → Build → Peak → Taper). The 8 official stations with competition weights, periodized running and compromised running.",
    "hu": "12 hetes felkészülési terv · heti 3 edzésnap · 4 fázis (Alapozás → Építés → Csúcsosítás → Pihentetés). A 8 hivatalos állomás verseny-súlyokkal, periodizált futással és kompromittált futással."
  },
  "hyrox.phase_1": {
    "en": "Base",
    "hu": "Alapozás"
  ...
  "hyrox.plan_created": {
    "en": "HYROX plan created · {count} workouts ({label})",
    "hu": "HYROX terv létrehozva · {count} edzés ({label})"
  },
  "hyrox.plan_exists_body": {
    "en": "Replace it with a new one? The current plan and its progress will be deleted.",
    "hu": "Lecseréled egy újra? A jelenlegi terv és a benne lévő haladás törlődik."
  },
  "hyrox.plan_exists_title": {
    "en": "You already have a HYROX plan",
    "hu": "Már van HYROX terved"
  },
  "hyrox.replace": {
    "en": "Replace",
    "hu": "Csere"
  },
  "hyrox.server_unreachable": {
    "en": "Couldn't reach the server. Is the backend running?",
    "hu": "Nem értem el a szervert. Fut a backend?"
  },
  "hyrox.week_n": {
    "en": "Week {week}",
    "hu": "{week}. hét"
  },
  "hyrox.weeks_progress": {
    "en": "12-week preparation · {done} / {total} days done",
    "hu": "12 hetes felkészülés · {done} / {total} nap kész"
  },
  "leaderboard.athlete_fallback": {
    "en": "ATHLETE",
    "hu": "ATLÉTA"
  },
  "leaderboard.empty_country": {
    "en": "No country set on your account yet. Set it on the Account screen to appear on the national leaderboard.",
    "hu": "Még nincs ország beállítva a fiókodon. Állítsd be a Fiók képernyőn, hogy felkerülj a nemzeti listára."
  },
  "leaderboard.empty_general": {
    "en": "No one has earned XP in this round yet — be the first.",
    "hu": "Senki sem szerzett még XP-t ebben a körben — légy te az első."
  },
  "leaderboard.load_failed": {
    "en": "Couldn't load the leaderboard.",
    "hu": "Nem sikerült betölteni a ranglistát."
  },
  "leaderboard.scope_country": {
    "en": "COUNTRY",
    "hu": "ORSZÁG"
  },
  "leaderboard.scope_global": {
    "en": "GLOBAL",
    "hu": "GLOBAL"
  },
  "leaderboard.scope_rank": {
    "en": "LEVEL",
    "hu": "SZINT"
  },
  "leaderboard.scope_weekly": {
    "en": "WEEK",
    "hu": "HÉT"
  },
  "leaderboard.title": {
  ...
  "notif.channel_desc": {
    "en": "Daily reminder for your planned workouts.",
    "hu": "Napi emlékeztető a tervezett edzésekre."
  },
  "notif.channel_name": {
    "en": "Training reminder",
    "hu": "Edzés emlékeztető"
  },
  "notif.reminder_body": {
    "en": "Training day. Start your workout.",
    "hu": "Ma edzésnap. Indítsd a workoutot."
  },
  ...
  "oauth.apple_failed": {
    "en": "Couldn’t sign in with Apple ID.",
    "hu": "Nem sikerült belépni az Apple ID-val."
  },
  "oauth.apple_no_token": {
    "en": "Apple sign-in didn’t return a token.",
    "hu": "Az Apple bejelentkezés nem adott vissza tokent."
  },
  "oauth.continue_apple": {
    "en": "Continue with Apple",
    "hu": "Folytatás Apple-lel"
  },
  "oauth.continue_google": {
    "en": "Continue with Google",
    "hu": "Folytatás Google-lel"
  },
  "oauth.google_failed": {
    "en": "Couldn’t sign in with your Google account.",
    "hu": "Nem sikerült belépni a Google fiókkal."
  },
  "oauth.google_no_token": {
    "en": "Google sign-in didn’t return a token.",
    "hu": "A Google bejelentkezés nem adott vissza tokent."
  },
  "oauth.or": {
    "en": "or",
    "hu": "vagy"
  ...
  "plate.below_bar": {
    "en": "{kg}kg is below the bar weight.",
    "hu": "{kg}kg a rúd súlya alatt van."
  },
  "plate.minimum": {
    "en": "Minimum: {kg}kg (empty bar)",
    "hu": "Minimum: {kg}kg (üres rúd)"
  },
  "predefined.abs_legs": {
    "en": "Abs + Legs",
    "hu": "Has + Comb"
  ...
  "predefined.back_shoulders": {
    "en": "Back + Shoulders",
    "hu": "Hát + Váll"
  },
  "predefined.biceps_back": {
    "en": "Biceps + Back",
    "hu": "Bicepsz + Hát"
  },
  "predefined.chest_back": {
    "en": "Chest + Back",
    "hu": "Mell + Hát"
  },
  "predefined.chest_triceps": {
    "en": "Chest + Triceps",
    "hu": "Mell + Tricepsz"
  },
  "predefined.glutes_legs": {
    "en": "Glutes + Legs",
    "hu": "Glutesz + Comb"
  },
  "predefined.legs_calves": {
    "en": "Legs + Calves",
    "hu": "Láb + Vádli"
  },
  "predefined.shoulders_triceps": {
    "en": "Shoulders + Triceps",
    "hu": "Váll + Tricepsz"
  },
  "predefined.upper_body": {
    "en": "Upper body",
    "hu": "Felsőtest"
  },
  "progress.hours": {
  ...
  "pw.add_to_my_workouts": {
    "en": "Add to my workouts",
    "hu": "Hozzáadás az edzéseimhez"
  },
  "pw.appbar_title": {
    "en": "Recommended workout",
    "hu": "Ajánlott edzés"
  },
  "pw.db_unreachable": {
    "en": "Couldn't reach the exercise database.",
    "hu": "Nem sikerült elérni a gyakorlat-adatbázist."
  },
  "pw.save_failed": {
    "en": "Couldn't save. Is the server running?",
    "hu": "Nem sikerült menteni. Fut a szerver?"
  },
  "pw.subtitle_count": {
    "en": "{subtitle} · {count} exercises",
    "hu": "{subtitle} · {count} gyakorlat"
  },
  ...
  "rank.cap_reached": {
    "en": "CAP REACHED — LEGENDARY",
    "hu": "CAP ELÉRVE — LEGENDÁS"
  },
  "stagnation.advice": {
    "en": "{name} — stalled for {weeks} weeks.",
    "hu": "{name} — {weeks} hét stagnál."
  },
  "stagnation.try": {
    "en": " Try: {tips}",
    "hu": " Próbálj: {tips}"
  ...
  "training.delete_failed": {
    "en": "Couldn't delete.",
    "hu": "Nem sikerült törölni."
  },
  "training.delete_irreversible": {
    "en": "This action can't be undone.",
    "hu": "Ez a művelet nem visszavonható."
  },
  "training.delete_title": {
    "en": "Delete \"{name}\"",
    "hu": "\"{name}\" törlése"
  },
  "training.name_label": {
  ...
  "training.name_required": {
    "en": "Give the workout a name.",
    "hu": "Adj nevet az edzésnek."
  },
  "training.no_exercises": {
    "en": "No exercises",
    "hu": "Nincs gyakorlat"
  },
  "training.save_failed": {
    "en": "Couldn't save.",
    "hu": "Nem sikerült menteni."
  },
  "trainingslist.paused": {
    "en": "Paused · {done}/{total} sets done",
    "hu": "Félbehagyva · {done}/{total} szett kész"
  },
  "trainingslist.section_continue": {
    "en": "CONTINUE WORKOUT",
    "hu": "FOLYTATHATÓ EDZÉS"
  }
};
